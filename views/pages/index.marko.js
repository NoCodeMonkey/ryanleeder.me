      ...
      _arg: marko_merge({
          ...
          content: {
              renderBody: function renderBody(out) {
                ...
                include_tag({
                    _target: about_template
                  }, out, __component, "17");

                out.w("</div></section><section class=\"bg-light\"><div id=\"skills\" class=\"container\"><h2>Skills</h2><hr class=\"hline-face\">");
                ...
                out.w("</div></section><section class=\"bg-white\"><div id=\"experience\" class=\"container\"><h2>Experience</h2><hr class=\"hline-face\">");

                include_tag({
                    _target: timeline_template
                  }, out, __component, "28");

                out.w("</div></section><section class=\"bg-light\"><div id=\"portfolio\" class=\"container\"><h2>Portfolio</h2><hr class=\"hline-face\">");

                include_tag({
                    _target: portfolio_template
                  }, out, __component, "33");

                out.w("</div></section><section class=\"bg-white\"><div id=\"contact\" class=\"container\"><h2>Contact</h2><hr class=\"hline-face\">");
